...
export const DisplayProjects = (props: any) => {
    ...
    const maxTranslate = projectWrapperChildren / 2 * 33 * -1
    console.log(projectWrapperChildren)

    const translateSlide = (direction: string) => {
        if (direction == 'right' && TranslateSlider > maxTranslate) {
            console.log("slide")
    ...
    return (
        <div ref={projectsRef} className='workWrapper  flex section  justify-center md:mx-5  grid'>
            ...
            <div ref={displayRef} className={` sectionWrapper relative justify-center   flex flex-col `}   >
                ...
                <span ref={leftArrow} className={`projectsArrow projectsArrowLeft ${category == "All" && mainProject == "" ? "visible" : "hidden"}`} onClick={() => translateSlide('left')}>
                ...
                <span ref={rightArrow} className={`projectsArrow projectsArrowRight ${category == "All" && mainProject == "" ? "visible" : "hidden"}`} onClick={() => translateSlide("right")}>
                ...
                <div id='projectWrapper' ref={projectWrapper} className={`projectsWrapper md:gap-32s xs:gap-10 / flex md:justify-start xs:justify-center / my-4  `} style={{ transform: `translate(${TranslateSlider}%)` }}  >
