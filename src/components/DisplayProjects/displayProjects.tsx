    ...
    return (
        ...
        <div   className='sectionWrapper max-w-6xl justify-center m-auto section py-3 px-2 grid  '>
            ...
            <div>
                ...
                <ProjectConstructor title={'SmartBrain'} typeOfwork={'Full Stack'} password={''} tools={'react.js/ webpack/ tailwindcss/ Express/ postgresql/  '} aboutIt={'SmartBrain was the last project my course, this website takes url of an image and detects the face inside of it '} imgPath={smartBrainPrev} projectUrl={'https://mhamad-hmd.github.io/Smart-Brain/'} />
                </div>
        </div>
    )
}
