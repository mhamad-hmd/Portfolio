  ...
  return (
    ...
    <div ref={displayRef} className={`heroContainer max-w-7xl  / flex flex-col  items-center / object-top  transition-all duration-300 gap-4   ${className} `}>
      ...
      <div ref={greetingBox} className="greetingBox flex flex-col items-center justify-center gap-4 font-bold ">
        <h1 className='text-lg md:text-xl lg:text-3xl text-center max-w-prose '><span className={`autoType mainFont ${dark? "text-scndryLightColor" : "text-scndryColor"}   `} >Hi am Mohamad Hammoud <br/> I design and code your ideas into reality</span></h1>
        <p className={`md:text-base text-center max-w-prose xs:text-sm scndryFont ${dark? "text-scndryLightColor" : "text-scndryColor"}  font-medium px-4`}>Feel free to reach out if you need help in making a website for you or your business</p>
